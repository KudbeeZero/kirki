...
export type DomainEvent =
  | { type: 'order.filled'; payload: OrderFilledEvent }
  | { type: 'trade.executed'; payload: TradeExecutedEvent }
  | { type: 'achievement.unlocked'; payload: AchievementUnlockedEvent }
  | { type: 'season.rolled'; payload: SeasonRolledEvent }
  | { type: 'price.tick'; payload: PriceTickEvent }
...
export const REDIS_CHANNELS = {
  priceTicks: 'simcoin:price:ticks',
  trades: 'simcoin:trades',
  achievements: 'simcoin:achievements',
  seasons: 'simcoin:seasons',
} as const;
